...
@Entity
@Table(name = "single_claw_machine_inventory")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SingleClawMachineInventory {
    @Id
    @GeneratedValue(strategy = GenerationType.UUID)
    private UUID id;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "single_claw_machine_id", nullable = false)
    @NotNull
    private SingleClawMachine singleClawMachine;
