...
class BoxBinInventoryControllerIT extends BaseIntegrationTest {
    ...
    private String baseUrl() {
        return "/api/box-bins/" + boxBinId + "/inventory";
    }
    ...
    @Test
    void listInventory_boxBinNotFound_returns404() throws Exception {
        mockMvc.perform(get("/api/box-bins/" + UUID.randomUUID() + "/inventory"))
    ...
    void addInventory_valid_returns201() throws Exception {
        ...
        mockMvc.perform(post(baseUrl())
                ...
                .andExpect(jsonPath("$.quantity").value(10))
                .andExpect(jsonPath("$.boxBinId").value(boxBinId.toString()));
    }
