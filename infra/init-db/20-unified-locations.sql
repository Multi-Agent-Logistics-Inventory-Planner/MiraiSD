...
CREATE TABLE IF NOT EXISTS location_inventory (
    ...
    site_id UUID NOT NULL REFERENCES sites(id),  -- Denormalized for efficient site queries
...
-- Automatically sets site_id based on the location's storage_location
...
-- Display-only locations (like gachapons) should not have inventory rows
...
-- Get the storage location type for a given location
...
-- Get the full location code (e.g., "BOX_BINS:B1")
