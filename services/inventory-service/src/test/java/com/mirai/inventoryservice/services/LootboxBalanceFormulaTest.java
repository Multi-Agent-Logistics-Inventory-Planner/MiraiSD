...
class LootboxBalanceFormulaTest {
    ...
    void setUp() {
        ...
        lenient().when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(0L);
        ...
        lenient().when(reviewDailyCountRepository.sumExpiredReviewCountByUserId(eq(userId), any(LocalDate.class)))
                .thenReturn(0L);
    ...
    void freshEarnings() {
        when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(100L);
    ...
    void unspentCoinsExpire() {
        when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(100L);
        when(reviewDailyCountRepository.sumExpiredReviewCountByUserId(eq(userId), any())).thenReturn(100L);
    ...
    void freshEarningsAfterPastExpiry() {
        ...
        when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(150L);
        when(lootboxPlayRepository.sumCostByUserId(userId)).thenReturn(80L);
        when(reviewDailyCountRepository.sumExpiredReviewCountByUserId(eq(userId), any())).thenReturn(100L);
    ...
    void negativeAdjustmentExpiry() {
        ...
        when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(50L);
        ...
        when(reviewDailyCountRepository.sumExpiredReviewCountByUserId(eq(userId), any())).thenReturn(50L);
    ...
    void balanceClampsAtZero() {
        ...
        when(reviewDailyCountRepository.sumReviewCountByUserId(userId)).thenReturn(10L);
