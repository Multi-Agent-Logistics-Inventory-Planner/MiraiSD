    ...
    public List<ReviewSummaryResponseDTO> getMonthlySummaries(int year, int month) {
        ...
        return results.stream()
                .map(row -> {
                    ...
                    // Get last review date for this employee
                    Optional<LocalDate> lastReviewDate = reviewRepository.findLastReviewDateByEmployeeId(employeeId);
                    ...
                    return ReviewSummaryResponseDTO.builder()
                            ...
                            .lastReviewDate(lastReviewDate.orElse(null))
                            .build();
                })
                .collect(Collectors.toList());
    }
