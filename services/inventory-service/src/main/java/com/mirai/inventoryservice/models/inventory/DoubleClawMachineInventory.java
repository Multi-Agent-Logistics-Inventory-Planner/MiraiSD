...
@Entity
@Table(name = "double_claw_machine_inventory")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DoubleClawMachineInventory {
    @Id
    @GeneratedValue(strategy = GenerationType.UUID)
    private UUID id;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "double_claw_machine_id", nullable = false)
    @NotNull
    private DoubleClawMachine doubleClawMachine;
