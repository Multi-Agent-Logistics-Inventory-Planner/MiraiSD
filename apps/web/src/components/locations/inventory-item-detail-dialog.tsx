...
export function InventoryItemDetailDialog({
  ...
  const updateMutation = useUpdateInventoryMutation(locationType, locationId);
  const deleteMutation = useDeleteInventoryMutation(locationType, locationId);
          ...
          <div className="px-6 pb-6 space-y-6">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-mono font-medium">{locationCode}</p>
              </div>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              location <span className="font-mono">{locationCode}</span>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
