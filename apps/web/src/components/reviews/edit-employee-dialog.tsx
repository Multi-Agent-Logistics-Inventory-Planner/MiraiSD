...
import { updateReviewEmployee } from "@/lib/api/reviews";
...
export function EditEmployeeDialog({
  ...
  useEffect(() => {
    if (employee) {
      setCanonicalName(employee.canonicalName);
      setNameVariantsText(employee.nameVariants?.join("\n") || "");
    }
  }, [employee]);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Update the employee&apos;s name and name variants used for matching
            reviews.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="edit-canonical-name">Employee Name</Label>
            <Input
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-name-variants">
              Name Variants{" "}
